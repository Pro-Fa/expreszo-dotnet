...
public class ValueTests
{
    ...
    {
        var a = Value.Number.Of(v);
        var b = Value.Number.Of(v);
    ...
    {
        var a = Value.Number.Of(double.NaN);
        var b = Value.Number.Of(double.NaN);
        await Assert.That(a).IsNotSameReferenceAs(b);
    ...
    {
        var a = new Value.Array(ImmutableArray.Create<Value>(Value.Number.Of(1), Value.Number.Of(2)));
        var b = new Value.Array(ImmutableArray.Create<Value>(Value.Number.Of(1), Value.Number.Of(2)));
        var c = new Value.Array(ImmutableArray.Create<Value>(Value.Number.Of(2), Value.Number.Of(1)));
    ...
    {
        var a = Value.Object.From(new Dictionary<string, Value>
        {
            ["x"] = Value.Number.Of(1),
            ["y"] = Value.Number.Of(2),
        });
        var b = Value.Object.From(new Dictionary<string, Value>
        {
            ["y"] = Value.Number.Of(2),
            ["x"] = Value.Number.Of(1),
        });
        var c = Value.Object.From(new Dictionary<string, Value>
        {
            ["x"] = Value.Number.Of(1),
            ["y"] = Value.Number.Of(3),
        });
